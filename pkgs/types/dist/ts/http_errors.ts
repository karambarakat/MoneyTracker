...
// DO NOT MODIFY IT BY HAND. Instead, modify `src/json-schema/http_errors.ts`,
// and run json-schema-to-typescript to regenerate this file.
export interface HttpErrors_SomeFieldsRequired {
  status: 400;
...
export interface HttpErrors_TokenFailed {
  ...
  message: string;
  details: {
    name: "JsonWebTokenError" | "TokenExpiredError" | "NoTokenWasProvided" | "UnspecifiedError";
    date?: string;
  };
}


export interface HttpErrors_UnspecifiedError {
  status: 500;
